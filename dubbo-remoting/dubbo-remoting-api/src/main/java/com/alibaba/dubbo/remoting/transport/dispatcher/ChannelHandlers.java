...
public class ChannelHandlers {
    ...
    protected ChannelHandler wrapInternal(ChannelHandler handler, URL url) {
        ...
        Dispatcher adaptiveExtension = ExtensionLoader.getExtensionLoader(Dispatcher.class).getAdaptiveExtension();
        System.out.println("初始化 分发器adaptiveExtension-->"+adaptiveExtension.getClass());
        ChannelHandler dispatch = adaptiveExtension.dispatch(handler, url);
